...
PROD_TABLE_FQN = os.environ.get("PROD_TABLE",    f"{PROJECT_ID}.Prod.investors_prod")
...
OVERLAY_TABLE   = os.environ.get("OVERLAY_TABLE",   "overlay_investors_current")
...
GRIST_TABLE   = os.environ.get("GRIST_TABLE",   "Investors"))
...
STATE_BLOB     = os.environ.get("STATE_BLOB",     "states/.state_investors.json")
...
def load_overlay_temp(rows: List[Dict], dataset: str) -> str:
    ...
    temp_fqn = f"{PROJECT_ID}.{dataset}._overlay_investors_upserts_{ts}"
